...
//  GUIDEMO_ShowInfo("Bitmaps can be magnified...");
  GUI_DispStringHCenterAt("1/2/4/8 bpp bitmaps", xCenter, 10);
}
...
//  GUI_DrawBitmap(&_bmLadyBug, 20, 50);
  x      = (xSize >> 1) - (_bmLadyBug.XSize >> 1);
  y      = (ySize >> 1) - (_bmLadyBug.YSize >> 1);
  GUI_DrawBitmap(&_bmLadyBug, x, y);
//  GUIDEMO_ShowInfo("RLE Compressed bitmaps");
  GUI_DispStringHCenterAt("RLE Compressed bitmaps", xSize >> 1, 10);
  GUIDEMO_Wait(3000);
  GUIDEMO_DrawBk(0);
//  //
//  // 1/2/4/8 bpp bitmaps
